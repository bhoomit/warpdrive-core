...
def initialize_upload(options):
  initialize_upload(options.file, options.title,options.keywords,options.description,options.category,options.privacyStatus)

def py_upload(file, title,keywords, description,category,privacyStatus):
  youtube = get_authenticated_service()
  print file
  print title, keywords, description, category, privacyStatus
